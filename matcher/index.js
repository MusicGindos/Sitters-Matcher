...
var computeSync = function(origin,destination,callback){  // google-distance is async and we need it to be sync so we use wrapper with flag
...
var computeDistance = function(origin,destination) { // make compute distance sync with flag and while loop
...
var computeScore = function(parent,sitter,filter,distance,callback){ // compute match score between sitter-parent-child
